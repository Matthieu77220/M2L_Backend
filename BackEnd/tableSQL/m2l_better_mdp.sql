...
--
-- Hôte : 127.0.0.1
-- Généré le : mer. 13 mai 2026 à 10:13
...
(1, 1, 'superAdmin', 'Lucas', 'Martin', 'martin.lucas@gmail.com', '0612345601', '1998-04-12', 120.00, '$2b$10$1mR8qPWVGywG10N2gkUZreN6xbjA6OJLEPtxr.rOUTn2KmfEmVxOe', '2024-01-01', '2024-12-31', 'Mensuel'),
(2, 1, 'admin', 'Emma', 'Durand', 'durand.emma@gmail.com', '0612345602', '1999-06-23', 120.00, '$2b$10$vzbx45J26lHMbGkZq0OnlOUXKfu4ckd945e1YW9iD5yJ6OK5wT2Ay', '2024-01-01', '2024-12-31', 'standard'),
(3, NULL, 'utilisateur', 'Nathan', 'Lefevre', 'lefevre.nathan@gmail.com', '0612345603', '2000-02-15', 120.00, '$2b$10$OW0QEQ1Pq.n9wsrzkiM4/uO4cR3RJu55M/PSw3sqDkjwDgKDSlgDa', '2024-01-01', '2024-12-31', 'standard'),
(4, NULL, 'utilisateur', 'Chloe', 'Moreau', 'moreau.chloe@gmail.com', '0612345604', '1997-11-30', 120.00, '$2b$10$xFb1CwBnVIBzyqXF1GossOdlW5ZwYtvsvqdOTKqBOFvtie6FC6P8a', '2024-01-01', '2024-12-31', 'standard'),
(5, NULL, 'utilisateur', 'Hugo', 'Bernard', 'bernard.hugo@gmail.com', '0612345605', '1996-09-08', 120.00, '$2b$10$LrGUs0VzbHW.GCZ9kR237.iDTsW7l8XLjpp3/Fb2Yzqj7ndVWUAqW', '2024-01-01', '2024-12-31', 'standard'),
(6, NULL, 'utilisateur', 'Lea', 'Petit', 'petit.lea@gmail.com', '0612345606', '2001-01-19', 120.00, '$2b$10$JEJGXltTy48tMzyLXd9ntOa5.t1fo1KvhoOkIO3V0AiD31dyvSX/6', '2024-01-01', '2024-12-31', 'standard'),
(7, NULL, 'utilisateur', 'Tom', 'Roux', 'roux.tom@gmail.com', '0612345607', '1998-07-04', 120.00, '$2b$10$PTaHp7iTQCn8rtNg1AgfV.Gzn57SkAYaIpvbOks0u/Ook1MbdKws2', '2024-01-01', '2024-12-31', 'standard'),
(8, NULL, 'utilisateur', 'Manon', 'Fournier', 'fournier.manon@gmail.com', '0612345608', '1999-12-14', 120.00, '$2b$10$3QdeaZol6TAxczWSmtlaMOYIjqaM3wLSvWKZ9gFehL8z1gT2jtvCS', '2024-01-01', '2024-12-31', 'standard'),
(9, NULL, 'utilisateur', 'Alexis', 'Girard', 'girard.alexis@gmail.com', '0612345609', '1997-03-27', 120.00, '$2b$10$RcVEGqcwfigbJcYgudAx7OXF9PHN/XPI.hd9sfJrzka6buOT10Kcm', '2024-01-01', '2024-12-31', 'standard'),
(10, NULL, 'utilisateur', 'Sarah', 'Lambert', 'lambert.sarah@gmail.com', '0612345610', '2000-10-05', 120.00, '$2b$10$NM/Bj6Fx6ka.BY1vt1ib2uxCFXNY..GNX6iTWDVfgqrTYFL.RrtDG', '2024-01-01', '2024-12-31', 'standard'),
(31, NULL, 'utilisateur', 'eric', 'eric', 'eric.nguyenleclerc@gmail.com', '0605555555', '0000-00-00', 120.00, '$2b$10$0tlvq/YRVWB/gfZ2tGjmtO5EgXJHhvfAHnruY9pIhDhpIQrUdJpsq', NULL, NULL, NULL);
...
(9, 'chasuble', 100, 94, 3, 2),
(10, 'chasuble', 100, 89, 4, 2),
(11, 'chasuble', 100, 86, 5, 3),
(12, 'chasuble', 100, 92, 6, 3),
(13, 'crampon', 100, 84, 1, 1),
(14, 'crampon', 100, 79, 2, 1),
(15, 'crampon', 100, 91, 3, 2),
(16, 'crampon', 100, 86, 4, 2),
(17, 'crampon', 100, 76, 5, 3),
(18, 'crampon', 100, 81, 6, 3);
...
(14, 'LIC46347', '2026-04-04', '2027-04-04', 31);
...
(12, 2, 1, '2026-04-14', '18:00:00', '19:00:00', 978779),
(13, 1, 1, '2026-04-15', '18:00:00', '20:30:00', 993040);
...
--
ALTER TABLE `adherent`
  MODIFY `id_adherent` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=32;
...
--
ALTER TABLE `licence`
  MODIFY `id_licence` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=15;
